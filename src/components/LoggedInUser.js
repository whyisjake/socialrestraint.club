          ...
          <div>
            <div className="row">
              <div className="col-3">
                {this.props.picture.data.url &&
                  <img className="img-fluid" src={this.props.picture.data.url} alt={this.props.name} />
                }
              </div>
              <div className="col-9">
            ...
            <div className="row" style={{marginTop:'20px'}}>
              <div className="col-8 offset-2">
                <button className="btn btn-light btn-block btn-lg js-scroll-trigger" onClick={this.postMessage}>Share</button>
              </div>
            </div>
          </div>
        }
